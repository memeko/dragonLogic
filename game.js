(() => {
  ...
  const TASK_BANK = [
    { id: 1, prompt: "Запиши выражение: «a и b»", target: "a ∧ b" },
    { id: 2, prompt: "Запиши выражение: «a или b»", target: "a ∨ b" },
    { id: 3, prompt: "Запиши выражение: «не a»", target: "¬a" },
    { id: 4, prompt: "Запиши выражение: «a и не b»", target: "a ∧ ¬b" },
    { id: 5, prompt: "Запиши выражение: «не a или c»", target: "¬a ∨ c" },
    { id: 6, prompt: "Запиши выражение: «если a, то b»", target: "a → b" },
    { id: 7, prompt: "Запиши выражение: «a тогда и только тогда, когда b»", target: "a ↔ b" },
    { id: 8, prompt: "Запиши выражение: «a исключающее или b»", target: "a ⊕ b" },
    { id: 9, prompt: "Запиши выражение: «a и (b или c)»", target: "a ∧ (b ∨ c)" },
    { id: 10, prompt: "Запиши выражение: «(a или b) и c»", target: "(a ∨ b) ∧ c" },
    { id: 11, prompt: "Запиши выражение: «не (a и b)»", target: "¬(a ∧ b)" },
    { id: 12, prompt: "Запиши выражение: «не (a или c)»", target: "¬(a ∨ c)" },
    { id: 13, prompt: "Запиши выражение: «если a и b, то c»", target: "(a ∧ b) → c" },
    { id: 14, prompt: "Запиши выражение: «если a, то (b или c)»", target: "a → (b ∨ c)" },
    { id: 15, prompt: "Запиши выражение: «(a равносильно b) и не c»", target: "(a ↔ b) ∧ ¬c" },
    { id: 16, prompt: "Запиши выражение: «не a влечёт (b и c)»", target: "¬a → (b ∧ c)" },
    { id: 17, prompt: "Запиши выражение: «(a или b) и (не b или c)»", target: "(a ∨ b) ∧ (¬b ∨ c)" },
    { id: 18, prompt: "Запиши выражение: «(a и не b) или (не a и c)»", target: "(a ∧ ¬b) ∨ (¬a ∧ c)" },
    { id: 19, prompt: "Запиши выражение: «(a или не b) равносильно (c или a)»", target: "(a ∨ ¬b) ↔ (c ∨ a)" },
    { id: 20, prompt: "Запиши выражение: «не (a и (b или c))»", target: "¬(a ∧ (b ∨ c))" },
    { id: 21, prompt: "Запиши выражение: «(a ⊕ b) и не c»", target: "(a ⊕ b) ∧ ¬c" },
    { id: 22, prompt: "Запиши выражение: «если (a или b), то (не a и c)»", target: "(a ∨ b) → (¬a ∧ c)" },
    { id: 23, prompt: "Запиши выражение: «(не a или b) и (a или c)»", target: "(¬a ∨ b) ∧ (a ∨ c)" },
    { id: 24, prompt: "Запиши выражение: «(a и b) или (a и c)»", target: "(a ∧ b) ∨ (a ∧ c)" },
  ];
